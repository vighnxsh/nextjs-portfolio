...
export default function Home() {
  ...
  return (
    <div className="  px-4 sm:px-6 md:px-8 lg:px-16 xl:px-28 py-32  sm:py-32 md:py-36 lg:py-32 xl:py-28">
      ...
      <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
        <div className="mb-4">
          ...
          <GradualSpacing
            className=" text-3xl sm:text-3xl md:text-4xl font-medium tracking-[-0.1em] text-sky-100 dark:text-white"
            text="Hello... "
          />
        </div>
      ...
      <div className="mt-16 sm:mt-20 md:mt-24 lg:mt-32">
        ...
        <Skills />
        <h1 className="text-3xl sm:text-4xl md:text-5xl text-center text-transparent bg-clip-text bg-gradient-to-r from-violet-950 via-violet-600 to-violet-950 font-bold mt-16 mb-8">
